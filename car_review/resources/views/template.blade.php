...
<html lang="en">
    ...
    <?php
                ...
                if($admin == "admin"){
                    $admin = true;
                    $pages = Request::segment(2);
                }else{
                    $admin = false;
                    $pages = Request::segment(1);
                }
            if(strpos(Request::segment(1), 'register') !== false){
                ?>
    <?php
            }elseif(strpos(Request::segment(1), 'admin') !== false && Request::segment(2) == null){
    ?>

    <?php
            }elseif(strpos(Request::segment(1), 'login') !== false ){
    ?>
